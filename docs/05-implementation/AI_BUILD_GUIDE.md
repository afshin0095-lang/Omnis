...
5. `docs/01-architecture/PLATFORM_FOUNDATION.md`
6. `docs/04-specifications/SYSTEM_SPEC.md`
7. the relevant domain document under `docs/04-specifications/`
8. relevant contracts under `docs/03-contracts/`
9. relevant ADRs under `docs/07-decisions/`
10. the existing implementation and tests
